...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/06 16:55:34 by cqin              #+#    #+#             */
/*   Updated: 2024/02/06 16:55:36 by cqin             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	 o << "PresidentialPardonForm Request Form: " << president.getName() << ", Signed: " << (president.isSigned() ? "Yes" : "No")
      << ", Grade to Sign: " << president.getGradeSigned() << ", Grade to Execute: " << president.getGradeExecute() << std::endl;
    return o;
}
